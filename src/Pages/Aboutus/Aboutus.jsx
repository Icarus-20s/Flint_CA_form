  ...
  return (
    <div className="kbps-about-page">
      ...
      <section className="kbps-hero-section" style={{ backgroundImage: 'url(images/img15.jpg)' }}>
        ...
        <Container>
          <div className="kbps-hero-content">
            <h1 className="kbps-hero-title">About K.B.P.S & Associates</h1>
            <div className="kbps-title-underline"></div>
            <p className="kbps-hero-subtitle">A trusted partner for your financial success since 2017</p>
            <Button 
              variant="primary" 
          ...
          <Row className="kbps-story-content align-items-center">
            <Col lg={5} md={12} className="kbps-story-image-wrapper">
              <div className="kbps-story-image-container">
                ...
                <div className="kbps-experience-badge">
                  ...
                  <span className="kbps-text">Years of Excellence</span>
                </div>
              </div>
            </Col>
            ...
            <Col lg={7} md={12} className="kbps-story-text-wrapper">
              <div className="kbps-story-text">
                <h3 className="kbps-story-subtitle">Chartered Accountants with a Difference</h3>
                <p>
      ...
      <section className="kbps-section kbps-ca-nepal-section">
        <Container>
          <div className="kbps-section-header text-center">
            <h2 className="kbps-section-title">Chartered Accountancy in Nepal</h2>
            <div className="kbps-section-divider"></div>
          </div>
          
          <div className="kbps-intro-text-container text-center">
            <p className="kbps-intro-text">
              Chartered Accountants (CAs) in Nepal hold a critical position in the nation's financial ecosystem. 
              As trusted financial advisors, auditors, and tax consultants, they are integral to the success of 
              businesses and the economy. The profession is overseen by the Institute of Chartered Accountants 
              of Nepal (ICAN), which ensures adherence to the highest standards of financial reporting, 
          ...
          <Row className="kbps-facts-row">
            <Col lg={4} md={6} sm={12} className="kbps-fact-col">
              <div className="kbps-fact-card">
                ...
                <p>
                  The demand for Chartered Accountants in Nepal has seen significant growth in recent years. 
                  As businesses evolve and expand, the need for qualified financial professionals who can 
                  navigate complex regulations and provide strategic guidance has never been higher.
                </p>
              </div>
            </Col>
            ...
            <Col lg={4} md={6} sm={12} className="kbps-fact-col">
              <div className="kbps-fact-card">
                ...
                <p>
                  The Institute of Chartered Accountants of Nepal (ICAN) is the authoritative body regulating 
                  the CA profession in Nepal. ICAN ensures that all Chartered Accountants maintain high 
                  standards of professionalism, ethics, and expertise.
                </p>
              </div>
            </Col>
            ...
            <Col lg={4} md={6} sm={12} className="kbps-fact-col">
              <div className="kbps-fact-card">
                ...
                <p>
                  Nepali Chartered Accountants are recognized globally and are in demand by international firms. 
                  Many Nepalese CAs work abroad in multinational corporations, helping to bridge the gap 
                  between Nepalese businesses and global markets.
                </p>
              </div>
            </Col>
          </Row>
            ...
            <Col lg={3} md={6} sm={12} className="kbps-service-col">
              <div className="kbps-service-card">
                ...
                <div className="kbps-service-hover">
                  <a href="#" className="kbps-service-link">Learn More</a>
                </div>
              </div>
            </Col>
        ...
        <Container>
          ...
          <div className="kbps-tabs-container">
            <div className="kbps-tabs-header">
              <button 
                className={`kbps-tab-btn ${activeTab === 'values' ? 'active' : ''}`} 
                onClick={() => setActiveTab('values')}
              >
                <i className="fas fa-gem me-2"></i>Core Values
              </button>
              <button 
                className={`kbps-tab-btn ${activeTab === 'vision' ? 'active' : ''}`} 
            ...
            <div className="kbps-tabs-content">
              {/* Values Tab */}
              <div className={`kbps-tab-pane ${activeTab === 'values' ? 'active' : ''}`}>
                <Row>
                  <Col md={6} lg={4} className="kbps-value-col">
              ...
              {/* Vision Tab */}
              <div className={`kbps-tab-pane ${activeTab === 'vision' ? 'active' : ''}`}>
                <div className="kbps-vision-container">
                  <div className="kbps-vision-statement">
                    <p>
                      To be recognized as a trusted and leading Chartered Accountants Firm, renowned for delivering 
                      exceptional financial and advisory services to our clients. We aspire to be the firm of choice 
                      for businesses, individuals, and organizations seeking expert guidance, innovative solutions, 
                      and unwavering integrity.
                    </p>
                  </div>
                  
                  <h5 className="kbps-vision-subtitle">Our vision is centered around the following key pillars:</h5>
      ...
      <section className="kbps-section kbps-team-section">
        <Container>
          <div className="kbps-section-header text-center">
            <h2 className="kbps-section-title">Our Leadership Team</h2>
            <div className="kbps-section-divider"></div>
          </div>
          
          <Row className="kbps-team-row">
            {teamMembers.map((member, index) => (
              <Col lg={4} md={6} sm={12} key={index} className="kbps-team-col">
      ...
      <section className="kbps-section kbps-testimonial-section">
        <Container>
          <div className="kbps-section-header text-center">
            <h2 className="kbps-section-title">What Our Clients Say</h2>
            <div className="kbps-section-divider"></div>
          </div>
            ...
            <div className="kbps-testimonial-controls">
              ...
              <div className="kbps-testimonial-indicators">
                {testimonials.map((_, idx) => (
                  <button
                    key={idx}
                    className={`kbps-indicator ${idx === activeTestimonial ? 'active' : ''}`}
        ...
        <div className="kbps-team-card-back">
          <div className="kbps-member-details">
            ...
            <div className="kbps-member-social">
              <a href="#" className="kbps-social-link"><i className="fab fa-linkedin-in"></i></a>
              <a href="#" className="kbps-social-link"><i className="fab fa-twitter"></i></a>
              <a href="#" className="kbps-social-link"><i className="fas fa-envelope"></i></a>
            </div>
          </div>
        </div>
      </div>
