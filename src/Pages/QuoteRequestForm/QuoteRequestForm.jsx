        ...
        {submitSuccess ? (
          ...
          <form onSubmit={handleSubmit} className="quote-request-form">
            <Grid container spacing={2} mt={1}>
              <Grid item xs={12}>
                <Typography variant="subtitle2" gutterBottom className="section-header">
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value="over-50000">Over ₹50,000</MenuItem>
                    <MenuItem value="not-sure">Not Sure / To Be Discussed</MenuItem>
                  </Select>
                </FormControl>
              </Grid>
