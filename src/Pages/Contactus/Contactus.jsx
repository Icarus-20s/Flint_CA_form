            ...
            <div className="contact-hero">
                <Container maxWidth="lg">
                    ...
                    <Typography variant="h6" className="contact-hero-subtitle">
                        Ready to elevate your financial strategy? Our CA
                            ...
                            <Grid2 size={{ xs: 12 }} md={5}>
                                <Box className="office-info-section">
                                    ...
                                    <Box className="office-details">
                                        ...
                                        >
                                            A professional CA firm providing
            ...
            >
                <Container maxWidth="lg">
                    ...
                    <Typography variant="body1" className="map-subtitle">
                        Located in the heart of Kathmandu, our office is easily
                        accessible
                    </Typography>
                </Container>
                ...
                <div className="map-container">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3531.158395801309!2d85.33028557543108!3d27.72847697620261!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb19001f99e28b%3A0x82b87ccd7e48ca29!2sK.%20B.%20P.%20S.%20%26%20Associates%2C%20Chartered%20Accountants!5e0!3m2!1sen!2snp!4v1720081892285!5m2!1sen!2snp"
                        width="100%"
                        height="450"
                        style={{ border: "0" }}
                        allowFullScreen=""
                        loading="lazy"
                        title="K.B.P.S. & Associates Location"
                    />
                </div>
            </motion.div>
                        ...
                        <Grid2 size={{ xs: 12 }} md={6}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    financial advisory, company incorporation,
                        ...
                        <Grid2 size={{ xs: 12 }} md={6}>
                            ...
                            >
                                <Typography
                                    ...
                                    className="faq-question"
                                >
                                    How quickly can I expect a response after
                                    contacting you?
                                </Typography>
                                <Typography
                                    variant="body1"
                                ...
                                >
                                    ...
                                    business hours. For urgent matters, please
                        ...
                        <Grid2 size={{ xs: 12 }} md={6}>
                            ...
                            >
                                ...
                                <Typography
                                    ...
                                    className="faq-answer"
                                >
                                    Yes, we offer virtual consultations via
                                    video conferencing platforms for clients who
                        ...
                        <Grid2 size={{ xs: 12 }} md={6}>
                            ...
                            >
                                <Typography
                                    ...
                                    className="faq-question"
                                >
                                    What information should I prepare for our
                                    first meeting?
                                </Typography>
                                <Typography
                                    variant="body1"
                                    className="faq-answer"
                                >
                                    For the initial consultation, please bring
                                    your business registration documents, recent
                                    financial statements, tax filings from the
                                    previous year, and any specific questions or
