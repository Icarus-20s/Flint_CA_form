...
const EmployeeReviews = () => {
    const reviews = [
        {
            name: 'John Doe',
            photo: 'public/Images/img2.jpg', // Replace with actual image URL
        ...
        {
            name: 'Jane Smith',
            photo: 'public/Images/img3.jpg', // Replace with actual image URL
        ...
        {
            name: 'Alex Johnson',
            photo: 'public/Images/img1.jpg', // Replace with actual image URL
